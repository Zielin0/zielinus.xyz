...
There are a couple not related to my question, but most of these boil down to: *Someone who writes computer programs*.
...
They actually had to read the documentation, and if it didn't exist they had to do everything themselves.
...
But still, this word is used in not software-related worlds as a description or a title for a person.
...
Repurposable means that you can write a piece of code that can be used in another environment or another software.
